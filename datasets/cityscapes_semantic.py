...
# ---------------------------------------------------------------
"""Cityscapes dataset wrapper class for semantic segmentation."""
...
class CityscapesSemantic(LightningDataModule):
    """Cityscapes dataset class for panoptic segmentation."""
    ...
    def setup(self, stage: Union[str, None] = None) -> LightningDataModule:
        ...
        self.cityscapes_train_dataset = Dataset(  # pylint: disable=W0201
            transforms=self.transforms,
            img_folder_path_in_zip=Path("./leftImg8bit/train"),
            target_folder_path_in_zip=Path("./gtFine/train"),
            **cityscapes_dataset_kwargs,
        )
        self.cityscapes_val_dataset = Dataset(  # pylint: disable=W0201
