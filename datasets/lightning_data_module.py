...
# ---------------------------------------------------------------
"""General dataset class for any target dataset and any task."""
...
class LightningDataModule(lightning.LightningDataModule):
    ...
    def train_collate(batch):
        """Pre-process the data in a batch for the training step."""
        imgs, targets = [], []
    ...
    def eval_collate(batch):
        """Pre-process the data in a batch for the evaluation step."""
