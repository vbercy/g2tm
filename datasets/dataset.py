...
# ---------------------------------------------------------------
"""General data loader class, for any dataset and any split."""
    ...
    def __init__(
        ...
        for img_info in sorted(img_zip.infolist(), key=self._sort_key):
            ...
            if not only_annotations_json:
                ...
                target_filename = (
                    target_parent / f"{target_stem}{target_suffix}"
                ).as_posix()
            ...
            if self.labels_by_id:
                ...
                if target_filename not in target_zip_filenames:  # pylint: disable=E0606
                    continue
