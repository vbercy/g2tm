...
# ---------------------------------------------------------------
"""Class handling image transformation and augmentation."""
...
class Transforms(nn.Module):
    """Data transformation and augmentation class."""
    ...
    def color_jitter(self, img):
        ...
        Args:
            img (torch.Tensor): An input image.
    ...
    def pad(
        ...
        """Pad the image and its associated labels.

        Args:
            img (torch.Tensor): An input image.
            target (dict[str, Any]): The target labels.

        Returns:
            img (torch.Tensor): The transformed image.
            target (dict[str, Union[Tensor, TVTensor]]): The transformed target labels.
        """
    ...
    def forward(
        ...
        """Transform an input image (color, flip, scale, pad, crop) and its associated
        labels.

        Args:
            img (torch.Tensor): An input image.
            target (dict[str, Union[Tensor, TVTensor]]): The target labels.
