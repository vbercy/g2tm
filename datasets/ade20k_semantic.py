...
# ---------------------------------------------------------------
"""ADE20K dataset wrapper class for semantic segmentation."""
...
class ADE20KSemantic(LightningDataModule):
    """ADE20K dataset class for semantic segmentation."""
    ...
    @staticmethod
    def target_parser(target, **kwargs):  # pylint: disable=W0613
