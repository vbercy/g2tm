...
# ---------------------------------------------------------------
"""Lightning wrapper module for EoMT for classification."""
...
class MaskClassificationLoss(Mask2FormerLoss):
    """LightningModule wrapper for a segmentation EoMT model (classification part)."""
    ...
    def loss_masks(  # pylint: disable=W0221
        self, masks_queries_logits, mask_labels, indices
    ):
        ...
        for key, value in loss_masks.items():
            loss_masks[key] = value / num_masks
