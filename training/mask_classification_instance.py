...
# ---------------------------------------------------------------
"""Lightning wrapper module for EoMT for instance segmentation task."""
...
class MaskClassificationInstance(LightningModule):
    """LightningModule wrapper for an instance segmentation EoMT model."""
    ...
    def eval_step(
        ...
        for i, (mask_logits, class_logits) in enumerate(
            ...
            preds, targets_ = [], []
            for j in range(len(mask_logits)):  # pylint: disable=C0200
