...
warnings.filterwarnings(
    "ignore",
    message="`torch._prims_common.check` is deprecated",
    ...
    LightningCLI(
        ...
        trainer_defaults={
            ...
            "callbacks": [
                ...
                ModelCheckpoint(filename="eomt-{epoch:02d}-{metrics/val_alias:.3f}",
                                auto_insert_metric_name=False, monitor="metrics/val_alias",
