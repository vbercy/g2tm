...
| Image classification | [Vision Transformer](https://arxiv.org/abs/2010.11929) | [`vit`](https://github.com/vbercy/g2tm/tree/vit) | ImageNet-1k, CIFAR-100, Oxford Flowers, Oxford Pets | [README](https://github.com/vbercy/g2tm/blob/vit/README.md) · [Results](https://github.com/vbercy/g2tm/blob/vit/RESULTS.md) |
...
# ViT + G2TM
git clone -b vit --single-branch https://github.com/vbercy/g2tm g2tm-vit
```
