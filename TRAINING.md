...
For more configuration options, see [vit/config.yml](vit/config.yml) and [vit/train.py](vit/train.py).
...
ViT + G2TM at layer 2 with threshold 0.88, and ViT-T backbone:
...
ViT + G2TM at layer 2 with threshold 0.88, and ViT-S backbone:
...
ViT + G2TM at layer 2 with threshold 0.88, and ViT-B backbone:
...
ViT + G2TM at layer 2 with threshold 0.88, and ViT-L backbone:
...
ViT + G2TM at layer 2 with threshold 0.94, ViT-L backbone, with 2 GPUs:
...
ViT + G2TM at layer 2 with threshold 0.94, and ViT-S backbone:

```bash
python ./vit/train.py --log-dir <citylarge_model_dir> \
...
ViT + G2TM at layer 2 with threshold 0.88, with Proportional Attention and ViT-S backbone:
...
ViT + G2TM at layer 2 with threshold 0.88, with Inverse Proportional Attention and ViT-S backbone:
...
ViT + G2TM at layer 2 with threshold 0.88, with curriculum and ViT-S backbone:
