...
"""Oxford Flowers 102 dataset wrapper class."""

from torchvision import datasets

from vit.data.base import BaseClassificationDataset
from vit.data.config.oxford_flowers import DATASET_CONFIG


class OxfordFlowersDataset(BaseClassificationDataset):
    """Oxford Flowers 102 dataset wrapper."""
