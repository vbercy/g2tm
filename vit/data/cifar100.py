...
"""CIFAR-100 dataset wrapper class."""

from torchvision import datasets

from vit.data.base import BaseClassificationDataset
from vit.data.config.cifar100 import DATASET_CONFIG


class CIFAR100Dataset(BaseClassificationDataset):
    ...
    def _build_dataset(self, **kwargs):
        train = DATASET_CONFIG["split_map"][self.split] == "train"
